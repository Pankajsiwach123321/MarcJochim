      ...
      <div className=" max-w-content px-3 mx-auto">
        <div className="row">
          <div className="md:w-7/12 w-full px-3">
            <h2
              data-aos="fade-down"
              className=" ff-neue font-normal text-4xl md:text-6xl leading-[44px] md:leading-[77px] text-center"
            >
              IT'S NOT
            </h2>
            <h2
              data-aos="fade-up"
              className=" ff-neue font-normal text-4xl md:text-6xl leading-[44px] md:leading-[77px] md:text-end text-center"
            >
