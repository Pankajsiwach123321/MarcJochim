      ...
      <div className="max-w-content mx-auto px-3">
        <div className="lg:py-[106px] py-10">
          <div className=" md:p-[50px_75px_42px_75px] p-5 backdrop-blur-sm bg-[#ffffff26] max-w-[778px] mx-auto">
            <h2 className=" font-normal uppercase leading-[62px] text-2xl md:text-5xl lg:text-[52px] text-center text-white ff-neue">
              Are you over your EX?
            </h2>
            <p className=" font-poppines font-normal text-base leading-[25px] pt-[9px] text-white text-center max-w-[585px] mx-auto">
